...
//PRINT A STRING
/**
 * print_string - fn Prints a string
 * @types:  arguments
 * @buffer: Buffer array to handle print
...
// PRINT STRING IN ROT1
/**
 * print_rot13string -function Print a string in rot13.
 * @types: List of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Compute active flags
 * @width: get width
